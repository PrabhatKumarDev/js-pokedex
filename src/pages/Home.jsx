...
import SurpriseButton from "../components/pokemon/SurpriseButton";
  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-border/50">
        ...
        <div className="pointer-events-none absolute top-0 left-1/4 h-64 w-64 bg-primary/5 rounded-full blur-3xl" />
        <div className="pointer-events-none absolute top-0 right-1/4 h-64 w-64 bg-accent/5 rounded-full blur-3xl" />

        {/* content */}
        <div className="relative z-10 flex flex-col justify-center items-center gap-6 py-16 px-4 md:py-24 border-b border-border/50 ">
          ...
          <div className="w-[80%] pt-4 flex flex-col gap-3 sm:flex-row sm:items-center">
